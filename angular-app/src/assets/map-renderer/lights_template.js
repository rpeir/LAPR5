...
export default class Lights {
  constructor(parameters) {
    ...
    this.object.pointLight1 = new THREE.PointLight(
      this.pointLight1.color,
      this.pointLight1.intensity,
      this.pointLight1.distance,
    );
    this.object.pointLight1.position.set(
      this.pointLight1.position.x,
      this.pointLight1.position.y,
      this.pointLight1.position.z,
    );
    ...
    this.object.pointLight2 = new THREE.PointLight(
      this.pointLight2.color,
      this.pointLight2.intensity,
      this.pointLight2.distance,
    );
    this.object.pointLight2.position.set(
