    ...
    keyChange(event, state) {
        ...
        if (document.activeElement == document.body) {
            ...
            /* To-do #41 - Toggle the user interface visibility
                ...
                - state: true*/
            if (event.code == this.player.keyCodes.userInterface && true) { // Display / hide user interface
                    ...
                    */
                    if (this.player.keyStates.backward) { // The player is moving backward
                        const newPosition = new THREE.Vector3(
                            ...
                            0, 
                            -coveredDistance*Math.cos(direction)).add(this.player.position);
                        ...
                        const newPosition = new THREE.Vector3(coveredDistance*Math.sin(direction), 
                        0, 
                        coveredDistance*Math.cos(direction)).add(this.player.position);
