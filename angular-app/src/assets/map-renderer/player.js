...
export default class Player extends THREE.Group {
    constructor(parameters) {
        ...
        this.onLoad = function (description) {
            ...
            this.body = this.getObjectByName("root_94"); // When visible, collision helpers are children of the body
            this.face = this.getObjectByName("Object_38"); // Required for computing the target of flashlight, first-person, third-person, and top-view cameras
            this.headEnd = this.getObjectByName("Object_24"); // Required by realistic view mode
            ...
            this.face.worldPosition = new THREE.Vector3(0,0.25,0);
