...
const routes: Routes = [
  ...
  {
    path: 'floors/building-pathways',
    component: ListOfBuildingWithPathwayComponent,
  ...
  {
    path: 'pathways/list-between-buildings',
    component: ListBetweenBuildingsComponent,
    canActivate: [campusManagerGuard],
  },
  ...
  { path: 'map-viewer', component: MapViewerComponent, canActivate: [combinedGuard] },
  ...
  {
    path: 'path/optimization-criteria',
    component: GetByOptimizationCriteriaComponent,
