...
export default class Maze {
    ...
    distanceToEastWall(position) {
        ...
        if (indices[1] < this.map[indices[0]].length && (this.map[indices[0]][indices[1]] == 1 || this.map[indices[0]][indices[1]] == 3)) {
    ...
    distanceToSouthWall(position) {
        ...
        if (indices[0] < this.map.length && (this.map[indices[0]][indices[1]] == 2 || this.map[indices[0]][indices[1]] == 3)) {
