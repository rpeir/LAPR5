...
export default function start() {
  ...
  function changeMap() {
    const floorMap = document.getElementById('mapSelector').value;
    initialize(floorMap);
  }
  ...
  function fetchBuildings() {
    ...
    fetch(environment.apiURL+'/api/buildings')
      ...
      .then(buildings => {
        ...
        // Add a default option or prompt if needed
        // buildingSelector.innerHTML += '<option value="">Select a Building</option>';
  ...
  function initialize() {
    ...
    thumbRaiser = new ThumbRaiser(
      ...
      {
        url: "./assets/map-renderer/mazes/Loquitas_10x10_displacement.json",
